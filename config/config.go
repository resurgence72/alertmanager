...
func (c *Config) UnmarshalYAML(unmarshal func(interface{}) error) error {
	...
	for _, rcv := range c.Receivers {
		...
		if rcv.InternalAlarmConfig.HTTPConfig == nil {
			rcv.InternalAlarmConfig.HTTPConfig = c.Global.HTTPConfig
		}
...
type Receiver struct {
	...
	InternalAlarmConfig *InternalAlarmConfig `yaml:"internal_config,omitempty" json:"internal_config,omitempty"`
