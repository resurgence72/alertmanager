...
var (
	DefaultInternalAlarmConfig = InternalAlarmConfig{
...
func (c *WebhookConfig) UnmarshalYAML(unmarshal func(interface{}) error) error {
	*c = DefaultWebhookConfig
	...
	// (*plain)(c) 类型转换，将 DefaultWebhookConfig类型 转换为 plain 类型
	if err := unmarshal((*plain)(c)); err != nil {
		return err
	}
	if c.URL == nil {
...
// 定义内部预警配置段
type InternalAlarmConfig struct {
	NotifierConfig `yaml:",inline" json:",inline"`
	HTTPConfig *commoncfg.HTTPClientConfig `yaml:"http_config,omitempty" json:"http_config,omitempty"`
	URL *URL `yaml:"url" json:"url"`
	RuleKeySet []Rule `yaml:"rule_key_set" json:"rule_key_set"`
}

func (c *InternalAlarmConfig) UnmarshalYAML(unmarshal func(interface{}) error) error {
	*c = DefaultInternalAlarmConfig
	type plain InternalAlarmConfig
	if err := unmarshal((*plain)(c)); err != nil {
		return err
	}
	if c.URL == nil {
